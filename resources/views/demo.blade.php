                ...
                <li>
                    <div class="user-view">
                        <div class="background">
                            <div style="width: 1280px; height: 720px; background-color: #1976D2">
                            </div>
                        </div>
                        <a href="#">
                        ...
                        <a href="#">
                            <span class="name white-text"><h3>ND</h3></span>
                        </a>
                    </div>
                </li>
                <li>
        ...
        <div class="col s12 m6 l4">
            ...
            <ul class="collection with-header latest-comments">
                ...
                <li class="collection-item avatar">
                    ...
                    <p class="truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt minima dolor
                        error laboriosam autem ad beatae
                        explicabo pariatur maxime fuga sed quod quo voluptas, adipisci illum aspernatur est, fugit
                        tempore.</p>
        ...
        <form>
            ...
            <div class="input-field">
                <select>
                    ...
                    <option value="2">Geaphic Design</option>
